import { milestones, mono, display, accent, SectionLabel, SectionTitle, StatusBadge, useIsMobile } from "../shared";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2px", marginTop: "32px" }}>
          {milestones.map((m, i) => (
            <div key={i} style={{
              ...
              <span style={{ fontFamily: mono, fontSize: isMobile ? "18px" : "24px", fontWeight: 700, color: m.status === "active" ? accent : "rgba(255,255,255,0.12)", paddingTop: isMobile ? "2px" : 0 }}>{m.phase}</span>
              <div>
                ...
                {isMobile && <div style={{ marginTop: "8px" }}><StatusBadge status={m.status} /></div>}
              </div>
